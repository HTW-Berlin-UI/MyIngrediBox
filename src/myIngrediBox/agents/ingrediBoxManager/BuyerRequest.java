...
public class BuyerRequest extends AchieveREInitiator {
	...
	// than also informs BuyerAgent, according which preferences to shop (e. g.
	// lowest cost, lowest leftovers)
	// than receives bought ingredients from BuyerAgent (if shopping went
	// successfully)
	...
	protected Vector prepareRequests(ACLMessage request) {
		...
		// Get buying preference
		BuyingPreference preference = (BuyingPreference) this.getDataStore().get("preference");
